...
onPointOffset = 0.2;
texts = [{ text: "My Smart Home System", size: 0.1 }, { text: "by Furtos Stelian", size: fontP / 2 }];
nextT = 0;
vehicles = [];
...
function setup() {
    ...
    document.getElementById("modalID").style.backgroundColor = rgbString(BACKGROUND_COLOR).replace(";", "");
    setTimeout(() => {
...
function mouseClicked() {
    ...
    if (mouseY <= canvasHeight && document.getElementById("login_modal").style.display != "block") {
